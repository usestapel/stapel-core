...
```bash
git clone https://github.com/usestapel/stapel-core.git && cd stapel-core
...
The packages use a flat layout (`package-dir = {{"stapel_core": "."}}`), so the
