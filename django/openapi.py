...
class BulkUpdateResponseSerializer(serializers.Serializer):
    ...
    updated_ids = serializers.ListField(
        ...
        help_text='List of created/updated object IDs'
    )
...
AUTH_EXAMPLES = {
    ...
    'rate_limit_error': OpenApiExample(
        ...
        value={'localizable_error': 'error.429.rate_limit', 'error': 'Too many attempts. Try again in 1 minutes.', 'params': {'retry_after': 30, 'retry_after_minutes': 1, 'retry_after_display': '0:30'}},
        response_only=True,
    ),
    'blocked_error': OpenApiExample(
        name='Account blocked',
        value={'localizable_error': 'error.422.blocked', 'error': 'Account temporarily blocked. Try again in 10 minutes.', 'params': {'retry_after': 600, 'retry_after_minutes': 10, 'retry_after_display': '10:00'}},
        response_only=True,
    ),
}
